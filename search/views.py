...
from LcvSearch.utils.common import OrderedSet
import redis
...
class SearchView(View):
    ...
    def get(self, request):
        ...
        if jobbole_count:
            jobbole_count = str(jobbole_count, encoding="utf-8")
        else:
            jobbole_count = 0
        job_count = redis_cli.get("job_count")
        if job_count:
            job_count = str(job_count, encoding="utf-8")
        else:
            job_count = 0
        zhihu_count = redis_cli.get("zhihu_count")
        if zhihu_count:
            zhihu_count = str(zhihu_count, encoding="utf-8")
        else:
            zhihu_count = 0
